...
const char *ssid = "Abhishek";  //ENTER YOUR WIFI SETTINGS
const char *password = "Abhiab1973";

//Web/Server address to read/write from 
const char *host = "192.168.80.92";   //IP address of server
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://192.168.80.92/loginsystem/postdemo.php" + getData;
